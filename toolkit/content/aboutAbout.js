...
function findAbouts() {
  ...
  for (var cid in Cc) {
    ...
    if (result) {
	  ...
	  var stringExclude = ["cache","networking","performance","privacore","privatebrowsing","robots","sessionrestore","telemetry","app-manager","sync-log","sync-tabs","accounts"];
...
function createProtocolListing(aProtocol) {
  ...
  link.href = uri;
  if(aProtocol == "credits")
  {
	link.href = "https://www.privafox.com/credits.html";
  }	
