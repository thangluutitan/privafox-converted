...
!define MaintFullName "Privacore Maintenance Service"
!undef BrandFullName
...
InstallDirRegKey HKLM "Software\Privacore\MaintenanceService" ""
...
; This is because we use only 1 service for all Privafox channels.
...
Section "MaintenanceService"
  ...
  WriteRegStr HKLM "${MaintUninstallKey}" "Publisher" "Privacore"
  ...
  WriteRegDWORD HKLM "Software\Privacore\MaintenanceService" "Installed" 1
  DeleteRegValue HKLM "Software\Privacore\MaintenanceService" "FFPrefetchDisabled"
  ...
  WriteRegStr HKLM "${FallbackKey}\1" "name" "Privacore Fake SPC"
  WriteRegStr HKLM "${FallbackKey}\1" "issuer" "Privacore Fake CA"
  ${If} ${RunningX64}
    SetRegView lastused
  ${EndIf}
SectionEnd
...
Section "Uninstall"
  ...
  ${If} ${RunningX64}
    SetRegView 64
  ${EndIf}
  DeleteRegValue HKLM "Software\Privacore\MaintenanceService" "Installed"
  DeleteRegValue HKLM "Software\Privacore\MaintenanceService" "FFPrefetchDisabled"
