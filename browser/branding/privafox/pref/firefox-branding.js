...
pref("app.update.url", "https://www.privafox.com/update/win64/%VERSION%/%LOCALE%/%CHANNEL%/update.xml");
...
pref("app.update.url.details", "https://www.privafox.com/releases/%VERSION%/notes.html");
