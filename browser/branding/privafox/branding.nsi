...
!define CompanyName           "Privafox Ltd"
!define URLInfoAbout          "https://www.privafox.com"
!define HelpLink              "https://www.privafox.com"

!define URLStubDownload "https://www.privafox.com"
!define URLManualDownload "https://www.privafox.com"
!define Channel "release"

# The installer's certificate name and issuer expected by the stub installer
!define CertNameDownload   "Privafox Ltd"
