...
Object.defineProperty(PrivafoxProfileMigrator.prototype, "sourceProfiles", {
    get: function() {
    return [{id: x, name: x} for (x of this._getAllProfiles().keys())].sort(sorter);
  }
});

PrivafoxProfileMigrator.prototype._getFileObject = function(dir, fileName) {
  let file = dir.clone();
...
PrivafoxProfileMigrator.prototype.getResources = function(aProfile) {
...
PrivafoxProfileMigrator.prototype._getResourcesInternal = function(sourceProfileDir, currentProfileDir, aProfile) {
...
PrivafoxProfileMigrator.prototype.classDescription = "Privafox Profile Migrator";
PrivafoxProfileMigrator.prototype.contractID = "@mozilla.org/profile/migrator;1?app=browser&type=privafox";
PrivafoxProfileMigrator.prototype.classID = Components.ID("{ACE9C7E0-789D-11E5-96E0-5C391E5D46B0}");

this.NSGetFactory = XPCOMUtils.generateNSGetFactory([PrivafoxProfileMigrator]);
