...
function setupSearch()
{
  ...
  gContentSearchController.engineName = searchEngineName;
  restoreSearchEngineFindx();
}
...
/*
 * Privafox : Change to Show notice a under search box .if the default seach engine is not findx.com
 */
function restoreSearchEngineFindx()
{
    let snippetsElt = document.getElementById("snippets");
    let entries = snippetsElt.querySelector("span");
    
    if(gContentSearchController.engineName == 'Findx')
    {        
